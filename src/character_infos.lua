...
local character_infos = {
	fighter = character_info_new('Fighter', 100, 20, 10, 10, {actions.attack, actions.slow_attack, actions.delayed_attack, actions.burn_all, actions.poison, actions.defend}),
